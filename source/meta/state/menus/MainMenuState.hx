...
class MainMenuState extends MusicBeatState
{
	...
	var backdrop:FlxBackdrop = new FlxBackdrop(Paths.image('menus/base/starBackdrop'), 0.2, 0.2, true, true);
	...
	override function update(elapsed:Float)
	{
		...
		backdrop.x +=200* elapsed;
		backdrop.y +=100* elapsed;
