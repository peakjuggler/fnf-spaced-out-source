...
class PlayState extends MusicBeatState
{
	...
	public static var beatHits:Stage;
	...
	override public function create()
	{
		...
		gf.setCharacter(300, 100, 'gf-scarlet');
	...
	private function generateSong(dataPath:String):Void
	{
		...
		if (storyDifficulty == 1)
		songMusic =	new FlxSound().loadEmbedded(Paths.inst(PlayState.SONG.song + '-stellar'), false, true);
		else
		songMusic = new FlxSound().loadEmbedded(Paths.inst(SONG.song), false, true);

		if (SONG.needsVoices && storyDifficulty == 1)
			vocals = new FlxSound().loadEmbedded(Paths.voices(PlayState.SONG.song + '-stellar'), false, true);
		else
