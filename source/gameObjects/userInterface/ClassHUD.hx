...
class ClassHUD extends FlxTypedGroup<FlxBasic>
{
	...
	public function new()
	{
		...
		new FlxTimer().start(5.0, function(guh:FlxTimer)
			{
				add(healthBarBG);
				FlxTween.tween(healthBarBG, {y: healthBarBG.y + 200}, 1.0, {type: FlxTweenType.BACKWARD, ease: FlxEase.expoInOut});
			});
		...
		new FlxTimer().start(5.0, function(guh:FlxTimer)
			{
				add(healthBar);
				FlxTween.tween(healthBar, {y: healthBar.y + 200}, 1.0, {type: FlxTweenType.BACKWARD, ease: FlxEase.expoInOut});
			});
		...
		new FlxTimer().start(5.0, function(guh:FlxTimer)
			{
				add(iconP1);
				FlxTween.tween(iconP1, {y: iconP1.y + 200}, 1.0, {type: FlxTweenType.BACKWARD, ease: FlxEase.expoInOut});
		...
		new FlxTimer().start(5.0, function(guh:FlxTimer)
			{
				add(iconP2);
				FlxTween.tween(iconP2, {y: iconP2.y + 200}, 1.0, {type: FlxTweenType.BACKWARD, ease: FlxEase.expoInOut});
		...
		new FlxTimer().start(5.0, function(guh:FlxTimer)
			{
				add(scoreBar);
				FlxTween.tween(scoreBar, {y: scoreBar.y + 200}, 1.0, {type: FlxTweenType.BACKWARD, ease: FlxEase.expoInOut});
			});
		...
		var engineBar:FlxText = new FlxText(0, FlxG.height - 720, 0, engineDisplay, 16);
		...
		new FlxTimer().start(5.0, function(guh:FlxTimer)
			{
				add(engineBar);
				FlxTween.tween(engineBar, {y: engineBar.y - 200}, 1.0, {type: FlxTweenType.BACKWARD, ease: FlxEase.expoInOut});
			});

		infoBar = new FlxText(5, FlxG.height - 720, 0, infoDisplay, 20);
		...
		new FlxTimer().start(5.0, function(guh:FlxTimer)
			{
				add(infoBar);
				FlxTween.tween(infoBar, {y: infoBar.y - 200}, 1.0, {type: FlxTweenType.BACKWARD, ease: FlxEase.expoInOut});
			});
	...
	public function beatHit()
	{
		...
		//FlxTween.tween(iconP1.scale, {x:1.1, y:1.1}, 0.1, {ease: FlxEase.quadInOut, type: FlxTweenType.PERSIST});
		//FlxTween.tween(iconP2.scale, {x:1.1, y:1.1}, 0.1, {ease: FlxEase.quadInOut, type: FlxTweenType.PERSIST});

		FlxTween.tween(iconP1.scale, {x:1.1, y:1.1}, 0.1, {ease: FlxEase.quadInOut, type: FlxTweenType.LOOPING, loopDelay: 0.5});
		FlxTween.tween(iconP2.scale, {x:1.1, y:1.1}, 0.1, {ease: FlxEase.quadInOut, type: FlxTweenType.LOOPING, loopDelay: 0.5});
